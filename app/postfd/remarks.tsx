...
const Review = () => {
  ...
  const filteredForms = submittedForms.filter((item) => {
    ...
    const isPostFund = item.fundStatus === "postfund";
    const isPending = item.formStatus === "Review";
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Post Review Forms</Text>
      ...
      {filteredForms.length === 0 ? (
        <Text style={styles.noDataText}>No Review forms found.</Text>
      ) : (
